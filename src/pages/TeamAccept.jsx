...
export default function TeamAccept() {
  ...
  const accept = async () => {
    ...
    try {
      ...
      setErr(e.message || 'Não foi possível aceitar o convite.')
    }
    setBusy(false)
  }
  ...
  return (
    <div className="auth-shell">
      <div className="auth-card">
        <h1>🌿 {SITE.appName}</h1>
        <p className="sub">Convite para a equipe da clínica</p>
        ...
        {done ? (
          ...
          <div style={{fontSize:12.5,color:'var(--txt2)',lineHeight:1.7,textAlign:'center'}}>
            Você recebeu um convite para operar como membro de equipe em uma clínica no {SITE.appName}.
          ...
          <div style={{textAlign:'center'}}>
            <p style={{fontSize:12.5,color:'var(--txt2)',marginBottom:14,lineHeight:1.7}}>
              Você está logada(o) como <strong>{session.user.email}</strong>. Confirme abaixo para aceitar o
              convite e passar a operar sobre os dados desta clínica de acordo com o papel definido pela
